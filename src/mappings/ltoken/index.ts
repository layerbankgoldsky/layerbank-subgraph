...
export function handleTransfer(event: TransferEvent): void {
  ...
  const transferID = transaction.id
    .concat("-")
  ...
  if (
    ...
    accountStateFrom.supplied = accountStateFrom.supplied.minus(
      event.params.amount
    );
...
export function handleRepayBorrow(event: RepayBorrowEvent): void {
  ...
  const repayBorrowID = transaction.id
    .concat("-")
    .concat(event.logIndex.toString());
...
//   const liquidateBorrowID = transaction.id
//     .concat("-")
//     .concat(event.logIndex.toString());
...
//   let borrowerState = loadAccountState(
//     event.params.borrower,
//     Address.fromBytes(event.address)
//   );
...
//   let liquidatorState = loadAccountState(
//     event.params.liquidator,
//     Address.fromBytes(event.params.lTokenCollateral)
//   );
//   liquidatorState.supplied = liquidatorState.supplied.plus(
//     event.params.seizeAmount
//   );
